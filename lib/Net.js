...
Net.prototype.disconnect = function (name) {
    if (this._nodes[name]) {
        this._nodes[name].removeListener('listen', this._listeners[name]['listen'])
        this._nodes[name].removeListener('send', this._listeners[name]['send'])
        this._nodes[name].removeListener('unlisten', this._listeners[name]['unlisten'])
    }
